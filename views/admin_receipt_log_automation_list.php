	...
	<div class="submit convert_orders convert_receipts convert_receipts_logs_automation">
		<?php if (isset($_GET['order_log'])) {
			if (!empty($_GET['order_log'])) {
				...
				$parent_post = get_post_meta($log_id, 'receipt_log_automation_order_id', true);
                ...
                if (!empty($invoice_uid)) {
                    ...
                    $file_name = $parent_link . '/wp-content/uploads/exported_html_files/'.$total_vat_number.$invoice_mark.'_html.zip';
