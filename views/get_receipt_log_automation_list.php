...
//				$user_last_name = $total_order->get_billing_last_name();
                ...
                $this->receipt_log_array[$receipt_log_count]['receipt_log_automation_invoice_id'] = $invoice_no ;
				//$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_invoice_id'] = get_post_meta(get_the_ID()+ 1 , '_primer_receipt_series', true) . " " . get_post_meta(get_the_ID()+ 1 , '_primer_receipt_number', true) ;
