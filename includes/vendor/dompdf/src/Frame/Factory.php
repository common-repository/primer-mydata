...
use DOMXPath;
use PrimerDompdf\FrameDecorator\Page as PageFrameDecorator;
use PrimerDompdf\FrameReflower\Page as PageFrameReflower;
use PrimerDompdf\Positioner\AbstractPositioner;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $decorator  = "PrimerDompdf\\FrameDecorator\\$decorator";
        $reflower   = "PrimerDompdf\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance($type)
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\PrimerDompdf\\Positioner\\'.$type;
