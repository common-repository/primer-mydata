...
namespace PrimerDompdf\Adapter;

use PrimerDompdf\Canvas;
use PrimerDompdf\Dompdf;
use PrimerDompdf\Helpers;
use PrimerDompdf\Exception;
use PrimerDompdf\Image\Cache;
use PrimerDompdf\PhpEvaluator;
...
class CPDF implements Canvas
{
    ...
    public function __construct($paper = "letter", $orientation = "portrait", Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \PrimerDompdf\Cpdf(
            $size,
            true,
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \PrimerDompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \PrimerDompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \PrimerDompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \PrimerDompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \PrimerDompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \PrimerDompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \PrimerDompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
